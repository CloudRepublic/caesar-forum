...
export function Navigation() {
  ...
  return (
    <nav className={`z-50 h-16 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 ${isAprilFools ? "fixed bottom-0 left-0 right-0" : "sticky top-0"}`}>
