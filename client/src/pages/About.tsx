...
const exampleSessions = [
  ...
  { type: "Brainstorm", title: "Opvallen op de volgende conferentie – bouw een game" },
  { type: "Brainstorm", title: "Welke IT trends negeren we (misschien onterecht)?" },
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 md:px-8">
      ...
      <div className="space-y-8">
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-foreground leading-relaxed">
              Een gevarieerd, unit-overstijgend aanbod van sessies. Denk aan tech, maar ook aan 
              andere onderwerpen die je raken, zoals personal development of gezondheid.
            </p>
            <p className="text-foreground leading-relaxed">
              Gebruik het Forum om inspirerende sessies te geven, samen nieuwe ideeën te ontwikkelen, 
              een dry-run van een conferentiepresentatie te doen en een kijkje te nemen achter de 
              schermen van andere units.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent className="space-y-4">
            <p className="text-foreground leading-relaxed">
              Het aanmeldformulier is ondertussen geopend. Heb je een leuk idee voor een sessie? 
              Meld je sessie direct aan!
            </p>
